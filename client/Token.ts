...
import { Config, TokenOptions, TokenSearchRules } from "../types.ts";
import { MeiliSearchError } from "./Errors.ts";
import { validateUuid4 } from "./utils.ts";
import crypto from "https://deno.land/std@0.173.0/node/crypto.ts";

export function encode64(data: any) {
